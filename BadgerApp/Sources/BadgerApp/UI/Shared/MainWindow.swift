...
struct ChatInterfaceView: View {
    ...
    // Status Bar State
    @State private var activeModelName: String = "Tiny Phi-3"
    @State private var isLocal: Bool = true
    @State private var tokenUsage: Int = 420
    @State private var vramUsage: Double = 4.2
    ...
    private func sendMessage() {
        ...
        Task {
            ...
            let aiMsg = ChatMessage(role: .assistant, content: "Response generated by \(activeModelName)...")
...
struct UnifiedSettingsView: View {
    ...
    var body: some View {
        TabView {
            ...
            AuditSettingsView()
                .tabItem { Label("Audit", systemImage: "list.bullet") }
        }
        .padding()
        .toolbar {
    ...
    var body: some View {
        Form {
            Section("Active Core") {
                ...
                LabeledContent("Model", value: "Phi-3 Mini")
            }
        }
    }
}
