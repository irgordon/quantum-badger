...
public struct TaskGoal: AppEntity, IndexedEntity, Identifiable, Sendable {
    ...
    public var attributeSet: CSSearchableItemAttributeSet {
        ...
        // Visual Metadata
        // Mapping status to specific system icons for high-glanceability.
        if status.lowercased().contains("complete") {
            attributes.thumbnailData = try? Data(contentsOf: URL(fileURLWithPath: "/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/Verified.icns")) // Placeholder
        }
