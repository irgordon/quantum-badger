...
3. **Hydration:** Raw JSON is validated against the **ToolRegistry**. Any step referencing an unknown tool is discarded or coerced into a "Human Approval Required" state.
